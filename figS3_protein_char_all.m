...
subplot(1,2,1)
    ...
    hold off
    ylabel('Number of Carbon Molecules','interpreter','latex','fontsize',fs)
...
subplot(1,2,2) 
    ...
    hold off
    ylabel('Number of Nitrogen Molecules','interpreter','latex','fontsize',fs)
    xlabel('Mass of protein (u)','interpreter','latex','fontsize',fs)
    textcorner('b',0.5,0.5,1.5*fs)
% % 
% % printpdf('figS3_CandN_vs_mass')
% % 
